...
htmlhelp_basename = "othdrplotdoc"
...
latex_documents = [
    (master_doc, "othdrplotdoc.tex", u"othdrplot Documentation", u"...", "manual"),
]
...
man_pages = [(master_doc, "othdrplotdoc", u"othdrplot Documentation", [author], 1)]
